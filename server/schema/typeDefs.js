...
type Mutation {
  ...
  editUserSelf(fullName: String!, firstName: String!, lastName: String!, preferredName: String!, birthday: String, password: String!, phone1: String, phone1Type: String, phone2: String, phone2Type: String, phone3: String, phone3Type: String, streetAddress: String, state: String, zipCode: String): Auth
}
`
