          ...
          <Form.Group controlId="formAdminUserPhone">
            <Row>
              ...
              <Col lg={{ span: 2, offset: 1 }}>
                ...
                {errors.phone2 &&
                  <div className="error"><p>{errors.phone2}</p></div>}
            ...
            <Row>
              <Col lg={{ span: 2, offset: 2 }}>
                ...
                {errors.phone3 &&
                  <div className="error"><p>{errors.phone3}</p></div>}
            ...
            <Row>
              ...
              <Col lg={4}>
                ...
                <Form.Select name="position" value={userData.position} className="formSelect" aria-label="Section" onChange={handleInputChange}>
                  ...
                  <option value="social media">Digital Media Specialist</option>
          ...
          <Form.Group controlId="formAdminAddress">
            <Row>
              ...
              <Col lg={2}>
                ...
                <Form.Control type="input" name="zipCode" placeholder={"80631"} value={userData.zipCode} className="formInput" onChange={handleInputChange} />
              </Col>
            </Row>
          </Form.Group>
